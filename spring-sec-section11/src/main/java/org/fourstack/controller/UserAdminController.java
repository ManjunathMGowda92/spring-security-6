...
import org.fourstack.model.AuthenticationDetails;
import org.fourstack.model.AuthenticationToken;
...
public class UserAdminController {
  ...
  public ResponseEntity<AuthenticationToken> authorizeUser(@RequestBody AuthenticationDetails details) {
    return null;
  }
}
