...
import org.fourstack.filter.JwtTokenGenerationFilter;
import org.fourstack.filter.JwtTokenValidationFilter;
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    ...
    return http.sessionManagement(session -> session.sessionCreationPolicy(SessionCreationPolicy.STATELESS))
            ...
            .csrf(csrfConfig -> csrfConfig.csrfTokenRequestHandler(csrfTokenRequestAttributeHandler)
                    .ignoringRequestMatchers("/api/v1/contact", "/api/v1/notices",
                            "/api/v1/user/register", "/api/v1/user/authenticate")
            ...
            .authorizeHttpRequests(requests ->
                    requests.requestMatchers("/api/v1/contact", "/api/v1/notices", "/welcome",
                                    "/error", "/api/v1/user/register", "/api/v1/user/authenticate").permitAll()
